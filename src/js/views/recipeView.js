...
class RecipeView extends View{
    ...
    addHandlerRender(handler){
        // CARA 1
        // window.addEventListener('hashchange', controlRecipe);  // Untuk menerima hashchange/link 
        // window.addEventListener('load', controlRecipe);

        // CARA 2
        const elementEV = ['hashchange', 'load'];
        elementEV.forEach(el => window.addEventListener(el, handler));
    }
